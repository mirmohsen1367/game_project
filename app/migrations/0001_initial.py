    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(upload_to=app.models.UserProfile.file_directory_path)),
                ('level', models.CharField(choices=[('low', 'LOW'), ('middel', 'MIDDEL'), ('hight', 'HIGHT')], default='low', max_length=10)),
